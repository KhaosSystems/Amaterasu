...
namespace AmaterasuDemo
{
	...
	public:
		...
		void Render() override
		{
			...
			if (GetDirection() == ENodeParameterDirection::Output)
			{
			...
			if (m_Connections.size() == 0)
			{
				...
				ImGui::SetCursorPos(GetWorldPosition());
				ImGui::DragFloat("1234", &test);
	...
	class KSPrintNode : public Node
	{
	public:
		KSPrintNode(NodeGraph* parent);
		virtual void Execute() override;
	};
